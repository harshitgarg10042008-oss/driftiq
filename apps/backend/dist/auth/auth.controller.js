...
let AuthController = class AuthController {
    ...
    async resetPasswordRequest(dto) {
        return this.authService.resetPasswordRequest(dto.email);
    }
    async resetPasswordConfirm(dto) {
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [reset_password_dto_1.ResetPasswordConfirmDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "resetPasswordConfirm", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)('me'),
    __param(0, (0, common_1.Request)()),
